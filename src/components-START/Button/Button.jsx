...
import { DownArrow1 } from "../../icons-START/DownArrow1";
import "./style.css";

export const Button = ({ hasIcon = true, text = "Button", selected, type, className }) => {
  ...
  return (
    <div
      className={`button ${state.type} selected-${state.selected} ${className}`}
      onClick={() => {
        dispatch("click");
      }}
    >
