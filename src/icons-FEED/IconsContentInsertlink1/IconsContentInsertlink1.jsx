...
export const IconsContentInsertlink1 = ({ className }) => {
  return (
    <svg
      className={`icons-content-insertlink-1 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
